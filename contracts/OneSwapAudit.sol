...
contract OneSwapAudit is IOneSwap, Ownable {
    ...
    {
        return
            oneSwapImpl.getExpectedReturnWithGas(
                srcToken,
                dstToken,
                amount,
                parts,
    ...
    {
        return oneSwapImpl.getExpectedReturnWithGasMulti(tokens, amount, parts, flags, dstTokenEthPriceTimesGasPrices);
    }
    ...
    function swap(
        ...
        return swapMulti(tokens, amount, minReturn, distribution, flagsArray);
    }
    ...
    function swapMulti(
        ...
        emit Swapped(tokens.first(), tokens.last(), amount, returnAmount, minReturn, distribution, flags);
